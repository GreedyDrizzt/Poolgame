...
//    BALLTYPE_NODECO = 0,
//    BALLTYPE_CUEBALL = 1,
//    BALLTYPE_BALLSPARKLE=2,
//    BALLTYPE_BALLSMASH=3,
//};
/**
...
public:
    ...
    virtual int GetBallType() override{return m_subBall->GetBallType();}
    virtual Ball* clone() override {
        return m_subBall->clone();
    }

    virtual bool isCue() override {
        return m_subBall->isCue();
    }
};
...
public:
    ...
    ~CueBall() {}
    virtual int GetBallType()override{return BallDecorator::GetBallType() | BallType::DECORATORTYPE_CUEBALL ;}
    /**
...
public:
    ...
    virtual Ball* clone() override {
       return new CueBall(BallDecorator::clone());
    }
...
public:
    ...
    virtual int GetBallType()override{return BallDecorator::GetBallType()| BallType::DECORATORTYPE_BALLSPARKLE;}
    virtual Ball* clone() override {
       return new BallSparkleDecorator(BallDecorator::clone());
    }
};
...
public:
    ...
    virtual int GetBallType()override{return BallDecorator::GetBallType() | BallType::DECORATORTYPE_BALLSMASH;}
    /**
    ...
    virtual Ball* clone() override {
       return new BallSmashDecorator(BallDecorator::clone());
    }
};
